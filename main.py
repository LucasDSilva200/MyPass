...
from util import create_file, apagar_registro, buscar_senha, exportar_senha, gerar_senha, listar_senha, salvar_senha
    ...
    while True:
        ...
        try:
            ...
            if option == 1:
                ...
                filepath = input(
                    "Digite o caminho do arquivo que deseja criar: ")
